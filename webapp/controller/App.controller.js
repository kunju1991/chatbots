sap.ui.define([
	...
	return Controller.extend("demo.mapanalyticMap.controller.App", {
		...
		/*
		*to get user uuid of your bot in recast ai
		*this unique key helps load the bot in ui5 from recast
		*/
		getBot:function(){
			var that = this;
			$.ajax({
				type: "GET",
				url:"https://api.recast.ai/auth/v1/owners/kunju1991",
				headers:{
					"Authorization": "85d5ef43ae66b50d375dd45415ef0729"
				},
				success: function(){
